  ...
  return (
    <MaxWidthWrapper>
      ...
      <Main>
        ...
        <SectionTitle>{'Purpose & Goal'}</SectionTitle>
        <SectionContents>
          <p>
        ...
        <FullBleed>
          <figure>
            <ImageWrapper style={{ '--aspect-ratio': '2079 / 1065' } as CSSProperties}>
              <Image
          ...
          <Caption>Figure 2: The Kubernetes manifest files</Caption>
        </FullBleed>
        <SectionContents>
          <p>
        ...
        <FullBleed>
          <figure>
            <ImageWrapper style={{ '--aspect-ratio': '2079 / 1197' } as CSSProperties}>
              <Image
                src='/image-tag.png'
          ...
          <Caption>Figure 3: The image tag for the current release</Caption>
        </FullBleed>
      </Main>
      <Footer />
    </MaxWidthWrapper>
